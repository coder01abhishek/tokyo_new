...
const HEAVY_FILES = [
  ...
  { local: 'public/videos/doll.mp4', remote: 'https://4b7mwyeirrypbewg.public.blob.vercel-storage.com/videos/doll.mp4', size: '18MB' },
  { local: 'public/videos/doll2.mp4', remote: 'https://4b7mwyeirrypbewg.public.blob.vercel-storage.com/videos/doll2.mp4', size: '19MB' },
  { local: 'public/videos/doll3.mp4', remote: 'https://4b7mwyeirrypbewg.public.blob.vercel-storage.com/videos//doll3.mp4', size: '16MB' },
  
  // Secondary videos
  { local: 'public/videos/AICharactor.mp4', remote: 'https://4b7mwyeirrypbewg.public.blob.vercel-storage.com/videos//AICharactor.mp4', size: '13MB' },
  { local: 'public/videos/step3.mp4', remote: 'https://4b7mwyeirrypbewg.public.blob.vercel-storage.com/videos//step3.mp4', size: '12MB' },
  
  // Large GIF
  { local: 'public/videos/doll.gif', remote: 'https://4b7mwyeirrypbewg.public.blob.vercel-storage.com/videos//doll.gif', size: '36MB' },
